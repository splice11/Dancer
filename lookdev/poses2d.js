// Frozen copy of the 2D renderer as it stood when the character was chosen.
// The live rig is 3D now; this keeps the look-dev sheets honest to their date.
import { pose } from './figure2d.js';
